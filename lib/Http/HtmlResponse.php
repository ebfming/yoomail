...
class HtmlResponse extends Response {
	...
	public function render(): string {
		...
		return '<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><style>'
			. 'html,body{color-scheme:light dark;margin:0;}'
			. 'body{padding:15px;background-color:#ffffff;}'
			. '@media (prefers-color-scheme: dark){body{background-color:#1c1c1e;color:#f5f5f5;}}'
			. '</style><script nonce="' . $this->nonce . '" src="' . $this->scriptUrl . '"></script></head><body>' . $this->content . '<div data-iframe-size></div></body></html>';
	}
}
