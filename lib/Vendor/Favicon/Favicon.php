...
namespace OCA\YooMail\Vendor\Favicon;
...
class Favicon
{
    ...
    private function getImage($url, $faviconUrl = '', $image = false)
    {
        ...
        // OCA\YooMail\Vendor\Favicon not found in the cache
        if ($favicon === false) {
    ...
    private function checkImageMTypeContent($content)
    {
        ...
        try {
            ...
            error_log('OCA\YooMail\Vendor\Favicon checkImageMTypeContent error: ' . $e->getMessage());
        }
