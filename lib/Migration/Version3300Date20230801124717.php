...
class Version3300Date20230801124717 extends SimpleMigrationStep {
	...
	public function changeSchema(IOutput $output, Closure $schemaClosure, array $options): ?ISchemaWrapper {
		...
		if (!$schema->hasTable('yoomail_messages_retention')) {
			$messagesRetentionTable = $schema->createTable('yoomail_messages_retention');
			...
			$messagesRetentionTable->setPrimaryKey(['id'], 'yoomail_msg_retention_id_idx');
		}
