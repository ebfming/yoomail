...
class Version1100Date20210419080523 extends SimpleMigrationStep {
	...
	public function changeSchema(IOutput $output, Closure $schemaClosure, array $options): ?ISchemaWrapper {
		...
		if (!$schema->hasTable('yoomail_provisionings')) {
			$provisioningTable = $schema->createTable('yoomail_provisionings');
	...
	public function postSchemaChange(IOutput $output, Closure $schemaClosure, array $options): void {
		...
		$insertQb->insert('yoomail_provisionings');
		...
		$updateQb = $updateQb->update('yoomail_accounts')
