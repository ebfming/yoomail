...
class Version5006Date20251023191023 extends SimpleMigrationStep {
	...
	public function changeSchema(IOutput $output, Closure $schemaClosure, array $options): ?ISchemaWrapper {
		...
		$mailboxes = $schema->getTable('yoomail_mailboxes');
		 ...
		 *
		 * @see \OCA\YooMail\Migration\Version0161Date20190902103701::changeSchema
		 * @see \OCA\YooMail\Migration\Version3500Date20231115184458::changeSchema
		 * @see \OCA\YooMail\Migration\Version5006Date20250927130132::changeSchema
		 * @see \OCA\YooMail\Migration\Version5006Date20251015082003::changeSchema
		 */
