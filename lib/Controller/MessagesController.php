...
use OCA\YooMail\Service\SnoozeService;
...
class MessagesController extends Controller {
			...
			$htmlResponse = $plain
				...
				: HtmlResponse::withResizer(
					...
					$this->urlGenerator->getAbsoluteURL(
						$this->urlGenerator->linkTo('yoomail', 'js/htmlresponse.js')
					)
				);
	...
	private function getCacheForAccount(int $accountId): ICache {
		return $this->cacheFactory->createDistributed("yoomail_account_$accountId");
	}
}
