...
use OCA\YooMail\Exception\UploadException;
use OCA\YooMail\Http\TrapError;
use OCA\YooMail\IMAP\IMAPClientFactory;
use OCA\YooMail\Model\SmimeData;
use OCA\YooMail\ResponseDefinitions;
...
use OCA\YooMail\Service\ItineraryService;
...
class MessageApiController extends OCSController {
	...
	private function enrichDownloadUrl(int $id, array $attachment): array {
		$downloadUrl = $this->urlGenerator->linkToOCSRouteAbsolute('yoomail.messageApi.getAttachment',
			[
				'id' => $id,
