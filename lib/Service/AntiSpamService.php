...
use OCA\YooMail\Model\Message;
use OCA\YooMail\Service\DataUri\DataUriParser;
use OCA\YooMail\SMTP\SmtpClientFactory;
...
class AntiSpamService {
	...
	public function getSpamEmail(): string {
		return $this->appConfig->getValueString('yoomail', self::NAME . '_spam');
	}

	public function getHamEmail(): string {
		return $this->appConfig->getValueString('yoomail', self::NAME . '_ham');
	}
	...
	public function setSpamEmail(string $email): void {
		$this->appConfig->setValueString('yoomail', self::NAME . '_spam', $email);
	}

	public function setHamEmail(string $email): void {
		$this->appConfig->setValueString('yoomail', self::NAME . '_ham', $email);
	}

	public function deleteConfig(): void {
		$this->appConfig->deleteKey('yoomail', self::NAME . '_spam');
		$this->appConfig->deleteKey('yoomail', self::NAME . '_ham');
	}
