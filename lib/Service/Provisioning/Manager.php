...
class Manager {
	public const MAIL_PROVISIONINGS = 'yoomail_provisionings';
	/** @var IAppManager */
	private $appManager;
	...
	public function updatePassword(IUser $user, ?string $password, array $provisionings): void {
		try {
			...
			// Ref \OCA\YooMail\Controller\PageController::index()
