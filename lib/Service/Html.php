...
use OCA\YooMail\Html\ProxyHmacGenerator;
use OCA\YooMail\Model\IMAPMessage;
use OCA\YooMail\Service\HtmlPurify\CidURIScheme;
use OCA\YooMail\Service\HtmlPurify\TransformCidDataAttr;
use OCA\YooMail\Service\HtmlPurify\TransformHTMLLinks;
use OCA\YooMail\Service\HtmlPurify\TransformImageSrc;
use OCA\YooMail\Service\HtmlPurify\TransformNoReferrer;
use OCA\YooMail\Service\HtmlPurify\TransformStyleURLs;
use OCA\YooMail\Service\HtmlPurify\TransformURLScheme;
use OCP\IRequest;
...
class Html {
	...
	public function sanitizeStyleSheet(string $styles): string {
		...
		$blockedUrl = new CSSString($this->urlGenerator->imagePath('yoomail', 'blocked-image.png'));
