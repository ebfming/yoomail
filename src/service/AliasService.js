...
export async function createAlias(accountId, alias, aliasName) {
	const url = generateUrl('/apps/yoomail/api/accounts/{id}/aliases', {
		id: accountId,
	})
...
export async function deleteAlias(accountId, aliasId) {
	const url = generateUrl('/apps/yoomail/api/accounts/{id}/aliases/{aliasId}', {
		id: accountId,
		aliasId,
	})
...
export async function updateSignature(accountId, aliasId, signature) {
	const url = generateUrl('/apps/yoomail/api/accounts/{id}/aliases/{aliasId}/signature', {
		id: accountId,
		aliasId,
	})
