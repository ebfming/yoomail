...
export async function deleteThread(id) {
	const url = generateUrl('/apps/yoomail/api/thread/{id}', {
		id,
	})
...
export async function snoozeThread(id, unixTimestamp, destMailboxId) {
	const url = generateUrl('/apps/yoomail/api/thread/{id}/snooze', {
		id,
	})
...
export async function unSnoozeThread(id) {
	const url = generateUrl('/apps/yoomail/api/thread/{id}/unsnooze', {
		id,
	})
