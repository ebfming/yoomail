...
export async function fetch(accountId) {
	const url = generateUrl('/apps/yoomail/api/out-of-office/{accountId}', { accountId })
...
export async function followSystem(accountId) {
	const url = generateUrl('/apps/yoomail/api/out-of-office/{accountId}/follow-system', { accountId })
