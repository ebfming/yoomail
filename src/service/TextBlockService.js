...
export async function fetchMyTextBlocks() {
	const url = generateUrl('/apps/yoomail/api/textBlocks')
...
export async function fetchSharedTextBlocks() {
	const url = generateUrl('/apps/yoomail/api/textBlockshares')
	return handleHttpAuthErrors(async () => {
		const response = await axios.get(url)
		return response.data.data
	})
...
export async function updateTextBlock(textBlock) {
	const url = generateUrl('/apps/yoomail/api/textBlocks/{id}', { id: textBlock.id })
	return handleHttpAuthErrors(async () => {
...
export async function deleteTextBlock(id) {
	const url = generateUrl('/apps/yoomail/api/textBlocks/{id}', { id })
	return handleHttpAuthErrors(async () => {
...
export async function getShares(id) {
	const url = generateUrl('/apps/yoomail/api/textBlocks/{id}/shares', { id })
	return handleHttpAuthErrors(async () => {
		const response = await axios.get(url)
		return response.data.data
	})
...
export async function unshareTextBlock(textBlockId, shareWith) {
	const url = generateUrl('/apps/yoomail/api/textBlockshares/{textBlockId}', { textBlockId })
	return handleHttpAuthErrors(async () => {
