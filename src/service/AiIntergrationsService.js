...
export async function summarizeThread(threadId) {
	const url = generateUrl('/apps/yoomail/api/thread/{threadId}/summary', {
		threadId,
	})
...
export async function generateEventData(threadId) {
	const url = generateUrl('/apps/yoomail/api/thread/{threadId}/eventdata', {
		threadId,
	})
...
export async function smartReply(messageId) {
	const url = generateUrl('/apps/yoomail/api/messages/{messageId}/smartreply', {
		messageId,
	})
...
export async function needsTranslation(messageId) {
	const url = generateUrl('/apps/yoomail/api/messages/{messageId}/needsTranslation', {
		messageId,
	})
