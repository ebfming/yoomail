...
export async function fetchAll(accountId, forceSync = false) {
	const url = generateUrl(`/apps/yoomail/api/mailboxes?accountId={accountId}&forceSync=${forceSync}`, {
		accountId,
	})
...
export function create(accountId, name) {
	const url = generateUrl('/apps/yoomail/api/mailboxes')
...
export function getMailboxStatus(id) {
	const url = generateUrl('/apps/yoomail/api/mailboxes/{id}/stats', {
		id,
	})
...
export function markMailboxRead(id) {
	const url = generateUrl('/apps/yoomail/api/mailboxes/{id}/read', {
		id,
	})
...
export async function deleteMailbox(id) {
	const url = generateUrl('/apps/yoomail/api/mailboxes/{id}', {
		id,
	})
...
export async function clearMailbox(id) {
	const url = generateUrl('/apps/yoomail/api/mailboxes/{id}/clear', {
		id,
	})
...
export async function repairMailbox(id) {
	const url = generateUrl('/apps/yoomail/api/mailboxes/{id}/repair', {
		id,
	})
