...
export function create(data) {
	const url = generateUrl('/apps/yoomail/api/accounts')
...
export function patch(account, data) {
	const url = generateUrl('/apps/yoomail/api/accounts/{id}', {
...
export function updateSignature(account, signature) {
	const url = generateUrl('/apps/yoomail/api/accounts/{id}/signature', {
		id: account.id,
	})
	const data = {
		signature,
...
export async function fetchQuota(id) {
	const url = generateUrl('/apps/yoomail/api/accounts/{id}/quota', {
		id,
	})
...
export async function updateSmimeCertificate(id, smimeCertificateId) {
	const url = generateUrl('/apps/yoomail/api/accounts/{id}/smime-certificate', {
		id,
	})
...
export async function testAccountConnection(id) {
	const url = generateUrl('/apps/yoomail/api/accounts/{id}/test', {
		id,
	})
