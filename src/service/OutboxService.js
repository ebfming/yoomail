...
export async function fetchMessages() {
	const url = generateUrl('/apps/yoomail/api/outbox')
...
export async function deleteMessage(id) {
	const url = generateUrl('/apps/yoomail/api/outbox/{id}', {
		id,
	})
...
export async function enqueueMessageFromDraft(id, message) {
	const url = generateUrl('/apps/yoomail/api/outbox/from-draft/{id}', {
		id,
	})
