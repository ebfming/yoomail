...
-->
<template>
	<NcDialog id="text-block-picker" :name="t('yoomail', 'Text blocks')" @closing="handleClose">
		<p>{{ t('yoomail', 'Choose a text block to insert at the cursor') }}</p>
		<ListItem
		...
		<NcButton
			...
			{{ t('yoomail', 'Insert') }}
			<template #icon>
				<IconCheck :size="20" :name="t('yoomail', 'Insert text block')" />
			</template>
		</NcButton>
	</NcDialog>
</template>
