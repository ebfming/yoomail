...
<template>
	<div class="action">
		...
		<NcButton
			:aria-label="t('yoomail', 'Delete action')"
			...
			availableTypes: [
				{
					...
					label: this.t('yoomail', 'Mark message as'),
				},
				{
					id: 'addflag',
					label: this.t('yoomail', 'Add flag'),
				},
				{
					id: 'fileinto',
					label: this.t('yoomail', 'Move into folder'),
				},
				{
					id: MailFilterActions.Stop,
					label: this.t('yoomail', 'Stop'),
				},
			],
		}
	},
