		...
		<form class="modal__content" @submit.prevent="updateFilter">
			...
			<div class="filter-tests">
				...
				<NcButton
					class="add-condition"
					variant="secondary"
					:aria-label="t('yoomail', 'Add condition')"
					@click="createTest">
					{{ t('yoomail', 'Add condition') }}
				</NcButton>
			</div>

			<div class="filter-actions">
				<h6>{{ t('yoomail', 'Actions') }}</h6>
				...
				<NcButton
					class="add-action"
					variant="secondary"
					:aria-label="t('yoomail', 'Add action')"
					@click="createAction">
					{{ t('yoomail', 'Add action') }}
				</NcButton>
			</div>
