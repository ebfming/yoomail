...
<template>
	<div class="new-message-attachments">
		<div
			...
			<span>
				{{ n('yoomail', '{count} attachment', '{count} attachments', attachments.length, { count: attachments.length }) }} ({{ formatBytes(totalSizeOfUpload()) }})
			</span>
