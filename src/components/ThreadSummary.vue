		...
		<div class="summary">
			<div class="summary__header">
				<div class="summary__header__actions">
					...
					<NcButton
						:aria-label=" t('yoomail', 'Go to latest message')"
						variant="tertiary-no-background"
						@click="onScroll">
						{{ t('yoomail', 'Newest message') }}
						<template #icon>
			...
			<div class="summary__notice">
				{{ t('yoomail', 'This summary is AI-generated and may contain mistakes.') }}
			</div>
		</div>
	</NcAssistantContent>
</template>
...
export default {
	...
	computed: {
		brand() {
			if (OCA.Theming) {
				return t('yoomail', '{name} Assistant', { name: OCA.Theming.name })
			}
			return t('yoomail', '{name} Assistant', { name: 'Nextcloud' })
		},
	},
