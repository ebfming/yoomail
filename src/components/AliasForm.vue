	...
	<div class="alias-form">
		<form
			...
			<input
				...
				:aria-label="t('yoomail', 'Alias name')"
				required>
			<input
				v-model="changeAlias"
				...
				type="email"
				class="alias-form__form__input"
				:aria-label="t('yoomail', 'Email address')"
				required>
		</form>
		<div v-else>
		...
		<div class="alias-form__actions">
			<template v-if="showForm">
				<NcButton
					...
					:aria-label="t('yoomail', 'Update alias')"
					type="submit"
					:form="formId"
					:name="t('yoomail', 'Update alias')">
					<template #icon>
			...
			<template v-else>
				...
				<NcButton
					v-if="enableUpdate"
					variant="tertiary-no-background"
					:aria-label="t('yoomail', 'Rename alias')"
					:name="t('yoomail', 'Show update alias form')"
				...
				<NcButton
					...
					variant="tertiary-no-background"
					:aria-label="t('yoomail', 'Delete alias')"
					:name="t('yoomail', 'Delete alias')"
