...
<template>
	<div
		...
		role="region"
		:aria-label="t('yoomail', 'Message body')">
		...
		<div
			...
			<p>
				{{ t('yoomail', 'Warning: The S/MIME signature of this message is  unverified. The sender might be impersonating someone!') }}
			</p>
		</div>
...
export default {
	...
	data() {
		return {
			aiInfo: t('yoomail', 'Suggested replies are using AI'),
		}
	},
	...
	computed: {
		...
		htmlUrl() {
			return generateUrl('/apps/yoomail/api/messages/{id}/html', {
