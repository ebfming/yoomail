...
<template>
	<AppContentDetails
		...
		<div class="no-message-selected__heading">
			{{ t('yoomail', 'Welcome to {productName} Mail', { productName }, null, { escape: false }) }}
		</div>
		<div class="no-message-selected__text">
			{{ t('yoomail', 'Start writing a message by clicking below or select an existing message to display its contents') }}
		</div>
