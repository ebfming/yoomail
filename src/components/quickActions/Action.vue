	...
	computed: {
		...
		actionTitle() {
			switch (this.action.name) {
				case 'markAsSpam':
					return this.t('yoomail', 'Mark as spam')
				case 'applyTag':
					return this.t('yoomail', 'Tag')
				case 'moveThread':
					return this.t('yoomail', 'Move thread')
				case 'deleteThread':
					return this.t('yoomail', 'Delete thread')
				case 'markAsRead':
					return this.t('yoomail', 'Mark as read')
				case 'markAsUnread':
					return this.t('yoomail', 'Mark as unread')
				case 'markAsImportant':
					return this.t('yoomail', 'Mark as important')
				case 'markAsFavorite':
					return this.t('yoomail', 'Mark as favorite')
				default:
