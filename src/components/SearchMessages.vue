	...
	<div class="search-messages">
		<div class="search-messages__input">
			<input
				...
				:placeholder="t('yoomail', 'Search in folder')"
				:aria-label="t('yoomail', 'Search in folder')"
				@focus="showButtons = true"
				@blur="hideButtonsWithDelay(true)">
			<NcButton
				variant="tertiary"
				:aria-label="t('yoomail', 'Open search modal')"
			...
			<NcDialog
				...
				:name="t('yoomail', 'Search parameters')"
				size="normal"
				class="search-modal"
					...
					<div class="modal-inner--field">
						...
						<div class="modal-inner--container">
							<input
								...
								type="text"
								class="search-input"
								:placeholder="t('yoomail', 'Search subject')">
						</div>
					</div>
					<div class="modal-inner--field">
						...
						<div class="modal-inner--container">
							<input
								...
								type="text"
								class="search-input"
								:placeholder="t('yoomail', 'Search body')">
						</div>
					</div>
					<div class="modal-inner--field">
						...
						<div class="modal-inner--container range">
							<div class="modal-inner-inline">
								<NcDateTimePickerNative
									v-model="startDate"
									type="date"
									:label="t('yoomail', 'Pick a start date')"
									confirm />
							</div>
							<div class="modal-inner-inline">
								<NcDateTimePickerNative
									...
									:label="t('yoomail', 'Pick an end date')"
									confirm />
							</div>
						</div>
					</div>
					<div class="modal-inner--field">
						...
						<div class="modal-inner--container">
							<NcSelect
								...
								:placeholder="t('yoomail', 'Select senders')"
								:aria-label-combobox="t('yoomail', 'Select senders')"
								:multiple="true"
								:taggable="true"
					...
					<div class="modal-inner--field">
						...
						<div class="modal-inner--container">
							<NcSelect
								...
								:placeholder="t('yoomail', 'Select recipients')"
								:aria-label-combobox="t('yoomail', 'Select recipients')"
								:multiple="true"
								:taggable="true"
								:show-no-options="false"
								:preserve-search="true"
					...
					<div class="modal-inner--field">
						...
						<div class="modal-inner--container">
							<NcSelect
								...
								:placeholder="t('yoomail', 'Select CC recipients')"
								:aria-label-combobox="t('yoomail', 'Select CC recipients')"
								:multiple="true"
								:taggable="true"
								:show-no-options="false"
								:preserve-search="true"
					...
					<div class="modal-inner--field">
						...
						<div class="modal-inner--container">
							<NcSelect
								...
								:placeholder="t('yoomail', 'Select BCC recipients')"
								:aria-label-combobox="t('yoomail', 'Select BCC recipients')"
								:multiple="true"
								:taggable="true"
								:show-no-options="false"
								:preserve-search="true"
					...
					<div v-if="tags.length > 0" class="modal-inner--field">
						...
						<div class="modal-inner--container">
							<NcSelect
								...
								:placeholder="t('yoomail', 'Select tags')"
								:aria-label-combobox="t('yoomail', 'Select tags')"
						...
						<div class="modal-inner--container marked-as">
							...
							<div class="modal-inner-inline">
								<NcCheckboxRadioSwitch
									...
									name="flags[]"
									type="checkbox">
									{{ t('yoomail', 'Has attachments') }}
								</NcCheckboxRadioSwitch>
							</div>
							<div class="modal-inner-inline">
								<NcCheckboxRadioSwitch v-model="mentionsMe">
									{{ t('yoomail', 'Mentions me') }}
								</NcCheckboxRadioSwitch>
							</div>
						</div>
					</div>
...
export default {
	...
	data() {
		return {
			...
			dialogButtons: [
				{
					label: t('yoomail', 'Clear'),
					callback: () => this.resetFilter(),
					type: 'primary',
					icon: IconClose,
				},
				{
					label: t('yoomail', 'Search'),
