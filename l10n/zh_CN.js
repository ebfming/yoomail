OC.L10N.register(
    "yoomail",
    {    "Refresh mailbox" : "刷新邮箱",
    "Basic configuration" : "基础配置",
    "These options define YooMail defaults and sync behavior for the whole site." : "这些选项用于定义整个站点的 YooMail 默认行为与同步策略。",
    "Health check" : "健康检查",
    "Health check has not run yet." : "尚未执行健康检查。",
    "Check now" : "立即检查",
    "Time display default" : "时间显示默认值",
    "24-hour format" : "24 小时制",
    "12-hour format" : "12 小时制",
    "Recommended default for mixed-language and business environments." : "推荐作为多语言和企业环境下的默认显示格式。",
    "Users can still override this in their personal preferences later." : "用户后续仍可在个人偏好中覆盖这个默认值。",
    "Mail sync mode" : "收发机制",
    "Realtime sync (WebSocket)" : "实时收取（WebSocket）",
    "Prefer realtime notifications and mailbox refresh. HTTP sync remains available as a fallback path when needed." : "优先使用实时通知与列表刷新；必要时仍可由 HTTP 同步链路兜底。",
    "Async sync (HTTP)" : "异步收取（HTTP）",
    "Disable WebSocket usage and rely on the classic HTTP-based sync flow." : "关闭 WebSocket，完全依赖原有的 HTTP 同步流程。",
    "WebSocket is selected, but the realtime service is not healthy." : "当前已选择 WebSocket，但 realtime 服务健康检查未通过。",
    "Delete behavior" : "删除机制",
    "Sync local delete to mail server" : "本地删除同步到邮件服务器",
    "When enabled, deleting a message in YooMail also performs the delete or move-to-trash action on the mail server." : "启用后，在 YooMail 中删除邮件时，也会同步执行邮件服务器上的删除或移入回收站操作。",
    "Sync server delete back to YooMail" : "服务器删除同步回 YooMail",
    "When enabled, deletions detected from the mail server are also removed from YooMail local data during sync." : "启用后，同步过程中如果检测到服务器端已删除邮件，也会同步清理 YooMail 本地数据。",
    "Fetch range default" : "收取范围默认值",
    "This value is used as the default scope for first-time or rebuilt mailbox sync. It does not delete existing local mail." : "该值用作首次同步或重建邮箱缓存时的默认收取范围，不会删除现有本地邮件。",
    "Last 7 days" : "最近 7 天",
    "Last 30 days" : "最近 30 天",
    "Last 90 days" : "最近 90 天",
    "Last 180 days" : "最近 180 天",
    "Fetch all mail" : "收取全部邮件",
    "Message body cache cleanup" : "正文缓存清理",
    "Enable automatic cleanup for cached message bodies" : "启用邮件正文缓存自动清理",
    "Cached message bodies are stored in Nextcloud appdata and are trimmed by age first, then by total size." : "邮件正文缓存保存在 Nextcloud appdata 中，清理时会先按保存时长处理，再按总大小裁剪。",
    "Keep for days" : "保留天数",
    "Max size (MB)" : "最大大小（MB）",
    "Local attachment cleanup" : "本地附件清理",
    "Enable automatic cleanup for local draft attachments" : "启用本地草稿附件自动清理",
    "This cleanup only removes unattached local files. Attachments still linked to drafts or outbox messages are kept untouched." : "该清理仅移除未挂接到邮件的本地文件，仍关联草稿或待发邮件的附件不会被动到。",
    "Admin settings saved" : "管理员设置已保存",
    "Unsupported fetch range" : "不支持的收取范围",
    "Cleanup values must be positive numbers" : "清理配置必须是正数",
    "Unsupported time format" : "不支持的时间格式",
    "Unsupported mail sync mode" : "不支持的收发模式",
    "Realtime mode is disabled. YooMail will use classic HTTP sync." : "当前已关闭 realtime 模式，YooMail 将使用经典 HTTP 同步。",
    "Cannot connect to the realtime socket at %1$s:%2$s." : "无法连接 realtime socket：%1$s:%2$s。",
    "The public WebSocket URL is invalid." : "公开 WebSocket 地址格式无效。",
    "The public WebSocket URL must start with ws:// or wss://." : "公开 WebSocket 地址必须以 ws:// 或 wss:// 开头。",
    "Realtime sync is disabled. HTTP sync is active." : "实时同步已关闭，当前启用的是 HTTP 同步。",
    "Realtime socket is reachable at %1$s:%2$s." : "Realtime socket 可正常访问：%1$s:%2$s。",
    "Realtime socket check failed for %1$s:%2$s." : "Realtime socket 检查失败：%1$s:%2$s。",
    "YooMail notifications" : "YooMail 通知",
    "These reminders only work while a YooMail page is open in your browser." : "这些提醒仅在浏览器中打开 YooMail 页面时生效。",
    "These reminders work while any page from this Nextcloud site is open in your browser." : "这些提醒会在浏览器中打开当前 Nextcloud 站点任意页面时生效。",
    "Use native browser notifications for new mail" : "新邮件使用浏览器原生通知",
    "This uses the browser Notification API and does not change Nextcloud global notifications." : "此功能使用浏览器 Notification API，不会修改 Nextcloud 全局通知配置。",
    "Request browser permission" : "请求浏览器权限",
    "Enable sound notifications" : "启用声音提醒",
    "Sound playback depends on browser policy and usually requires at least one interaction with YooMail." : "声音播放受浏览器策略影响，通常至少需要先与 YooMail 页面交互一次。",
    "Sound playback depends on browser policy and usually requires at least one interaction with this Nextcloud site." : "声音播放受浏览器策略影响，通常至少需要先与当前 Nextcloud 站点交互一次。",
    "Play a sound for new mail" : "新邮件时播放提示音",
    "Play a sound when sending succeeds" : "发送成功时播放提示音",
    "Play a sound when sending fails" : "发送失败时播放提示音",
    "Test new mail sound" : "测试新邮件提示音",
    "Test send success sound" : "测试发送成功提示音",
    ...
    "Browser notification permission: not requested" : "浏览器通知权限：尚未请求",
    "Browser notifications unavailable" : "浏览器通知不可用",
    "Browser permission granted" : "浏览器权限已允许",
    "Open browser notification settings" : "打开浏览器通知设置",
    "Could not save YooMail notification settings" : "无法保存 YooMail 通知设置",
    "Could not load YooMail notification settings" : "无法加载 YooMail 通知设置",
    "YooMail notification settings saved" : "YooMail 通知设置已保存",
    "Browser notifications are already allowed" : "浏览器通知已允许",
    "Browser notifications were blocked. Please enable notifications for this site in your browser settings." : "浏览器通知已被阻止。请在浏览器设置中允许当前站点通知。",
    "Browser notifications are now allowed" : "浏览器通知现在已允许",
    "Browser notifications were denied. Please enable notifications for this site in your browser settings if you want to use them." : "浏览器通知已被拒绝。如需使用，请在浏览器设置中允许当前站点通知。",
    "Browser notification permission was not changed" : "浏览器通知权限未变化",
    "Failed to request browser notification permission" : "请求浏览器通知权限失败",
    "Sound playback was blocked by the browser" : "声音播放被浏览器拦截了",
    "Unknown sender" : "未知发件人",
    "(No subject)" : "（无主题）",
    "You have {count} new emails" : "你有 {count} 封新邮件",
    "New mail from {sender}" : "来自 {sender} 的新邮件",
    "Your message was sent successfully" : "你的邮件已成功发送",
    "Message sent" : "邮件已发送",
    "YooMail could not send this message" : "YooMail 无法发送这封邮件",
    "Message sending failed" : "邮件发送失败",
    "Refresh and retry" : "刷新并重试",
    "This email may have been deleted. Refresh the mailbox to fetch it again and retry." : "该邮件可能已经被删除。刷新邮箱后再次收取重试。",
